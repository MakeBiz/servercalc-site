...
export const metadata = {
  ...
  alternates: {
    canonical: '/en/about',
    languages: { ru: '/o-proekte', en: '/en/about', 'x-default': '/o-proekte' },
  },
};
  ...
  return (
    <>
      <PageHead
        ...
        crumbs={[{ href: '/en/about', label: 'About' }]}
        badges={
          <>
        ...
        <div className="wrap-narrow">
          ...
          <div className="grid-2 mt-lg">
            <div className="notice">
              ...
              see the <Link href="/en/methodology">methodology</Link>
            </div>
            <div className="notice">
              <strong>Want to know who we partner with.</strong> It is stated in every provider
              review, <Link href="/en/providers">the full list</Link>
            </div>
          </div>
