...
export const metadata = {
  ...
  alternates: {
    canonical: '/en/deals',
    languages: { ru: '/akcii', en: '/en/deals', 'x-default': '/akcii' },
  },
  ...
  return (
    <>
      ...
      <PageHead
        ...
        crumbs={[{ href: '/en/deals', label: 'Deals and promo codes' }]}
        badges={
          <>
        ...
        <div className="wrap">
          {!HAS_PROMOS ? (
            <div className="notice notice-warn" style={{ maxWidth: 720 }}>
              ...
              <Link href="/en/catalog">plan catalog</Link>: the base prices there are checked every
              week
            </div>
          ) : (
              ...
              {PROMOS.map((p) => (
                <div className="card" key={p.id}>
                  ...
                  <div className="row mt">
                    ...
                    <Link href={`/en/providers/${p.provider.slug}`} className="btn btn-ghost btn-sm">
                      Provider review
                    </Link>
                  </div>
          ...
          <div className="grid-2 mt-lg">
            ...
            <div className="notice">
              ...
              billing term. Check the renewal price in the <Link href="/en/catalog">catalog</Link>:
