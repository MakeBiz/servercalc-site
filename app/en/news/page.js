...
export const metadata = {
  ...
  alternates: {
    canonical: '/en/news',
    languages: { ru: '/novosti', en: '/en/news', 'x-default': '/novosti' },
  },
};
  ...
  return (
    <>
      ...
      <PageHead
        ...
        crumbs={[{ href: '/en/news', label: 'News' }]}
        badges={
          <>
      ...
      <section className="section paper">
        <div className="wrap">
          {posts.length > 0 && (
            <Link href={`/en/news/${posts[0].slug}`} className="news-featured">
          ...
          <div className="cards cards-2">
            {posts.slice(1).map((post) => (
              <Link key={post.slug} href={`/en/news/${post.slug}`} className="card">
