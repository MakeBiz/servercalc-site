...
export const metadata = {
  ...
  alternates: {
    ...
    languages: { ru: '/catalog', en: '/en/catalog', 'x-default': '/catalog' },
  },
};
  ...
  return (
    <>
          ...
          itemListElement: rows.slice(0, 40).map((r, i) => ({
            ...
            item: {
              ...
              offers: {
                ...
                url: absUrl(`/en/providers/${r.providerSlug}`),
              },
            },
          })),
        }}
      ...
      <PageHead
        ...
        crumbs={[{ href: '/en/catalog', label: 'Plan catalog' }]}
        badges={
          <>
        ...
        <div className="wrap">
          ...
          <div className="grid-3 mt-lg">
            <div className="notice">
              ...
              <Link href="/en/methodology">freshness rule</Link>
            </div>
            <div className="notice">
