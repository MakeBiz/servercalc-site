        ...
        <div className="wrap">
          ...
          <div className="cards" style={{ marginTop: 8 }}>
            ...
            <div className="card">
              ...
              <div className="card-foot">
                <Link href="/en/methodology" className="link-arrow">
                  Methodology
                </Link>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="card-foot">
                <Link href="/en/providers" className="link-arrow">
                  Provider reviews
                </Link>
              </div>
            </div>
      ...
      <section className="section paper-alt">
        <div className="wrap">
          ...
          <div className="cards cards-4">
            {TASKS.map((task) => (
              <Link key={task.slug} href={`/en/vps-for/${task.slug}`} className="card">
                <div className="card-top">
      ...
      <section className="section paper">
        <div className="wrap">
          ...
          <div className="cards cards-4 mt">
            {GEO_PAGES.map((geo) => (
              <Link key={geo.slug} href={`/en/vps-in/${geo.slug}`} className="card">
      ...
      <section className="section paper-alt">
        <div className="wrap">
          <div className="between mb">
            ...
            <Link href="/en/providers" className="btn btn-ghost">
              All providers
            </Link>
          </div>
          ...
          <div className="grid-2">
            <div>
              ...
              <div className="row mt">
                <Link href="/en/catalog" className="btn btn-brass">
                  Open the catalog
                </Link>
                <Link href="/en/methodology" className="btn btn-ghost">
                  How we score
                </Link>
              </div>
            </div>
