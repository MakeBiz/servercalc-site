...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `/en/providers/${slug}`,
      languages: {
        ru: `/provajdery/${slug}`,
        en: `/en/providers/${slug}`,
        'x-default': `/provajdery/${slug}`,
      },
    },
  };
}
  ...
  return (
    <>
      ...
      <PageHead
        ...
        lead={desc}
        crumbs={[
          { href: '/en/providers', label: 'Providers' },
          { href: `/en/providers/${slug}`, label: provider.name },
        ]}
        badges={
          <>
      ...
      <section className="section-tight paper-alt">
        <div className="wrap">
          <div className="notice">
            ...
            <Link href="/en/methodology">The matching formula is fully open</Link>
          </div>
        </div>
      </section>
    </>
