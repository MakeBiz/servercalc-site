...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `/ru/vps-dlya/${slug}` },
  };
}
  ...
  return (
    <>
      ...
      <PageHead
        ...
        lead={task.intent}
        crumbs={[
          { href: '/ru/vps-dlya', label: 'Задачи' },
          { href: `/ru/vps-dlya/${slug}`, label: task.name },
        ]}
        badges={
          <>
        ...
        <div className="wrap">
          ...
          <div className="grid-2 mt-lg">
            ...
            <div className="notice">
              ...
              <Link href="/ru/metodologiya">вся формула</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section paper">
        <div className="wrap">
          <div className="between mb">
            ...
            <Link href="/ru/catalog" className="btn btn-ghost">
              Весь каталог
            </Link>
          </div>
                  ...
                  <tbody>
                    {suited.slice(0, 12).map((p) => {
                      ...
                      return (
                        <tr key={p.id}>
                          <td>
                            <Link href={`/ru/provajdery/${p.providerSlug}`} style={{ textDecoration: 'none', fontWeight: 600 }}>
      ...
      {related.length > 0 && (
        <section className="section paper-alt">
          <div className="wrap">
            ...
            <div className="cards cards-2">
              {related.map((p) => (
                <Link key={p.slug} href={`/ru/novosti/${p.slug}`} className="card">
                  <div className="card-top">
        ...
        <div className="wrap">
          ...
          <div className="chips">
            {TASKS.filter((t) => t.slug !== slug).map((t) => (
              <Link key={t.slug} href={`/ru/vps-dlya/${t.slug}`} className="chip chip-light">
