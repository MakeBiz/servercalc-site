...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `/ru/novosti/${slug}` },
    openGraph: {
      type: 'article',
      title: post.title,
      description: post.description,
    ...
    <>
      <JsonLd
        data={{
          ...
          mainEntityOfPage: absUrl(`/ru/novosti/${slug}`),
          inLanguage: 'ru-RU',
        }}
      />
      ...
      <PageHead
        ...
        crumbs={[
          { href: '/ru/novosti', label: 'Новости' },
          { href: `/ru/novosti/${slug}`, label: post.title },
        ]}
        badges={
          <>
          ...
          {provider ? (
            <div className="cta-provider ink">
              ...
              <div className="row">
                ...
                <Link href={`/ru/provajdery/${provider.slug}`} className="btn btn-ghost">
                  Обзор и тарифы
                </Link>
                <Link href="/ru#podbor" className="btn btn-ghost">
                  Подобрать сервер
                </Link>
              </div>
            ...
            <div className="row" style={{ marginTop: 40 }}>
              <Link href="/ru#podbor" className="btn btn-brass">
                Подобрать сервер
              </Link>
