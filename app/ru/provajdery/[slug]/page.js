...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `/ru/provajdery/${slug}` },
  };
}
  ...
  return (
    <>
      ...
      <PageHead
        ...
        crumbs={[
          { href: '/ru/provajdery', label: 'Провайдеры' },
          { href: `/ru/provajdery/${slug}`, label: provider.name },
        ]}
        badges={
          <>
          ...
          <div className="grid-2">
            ...
            <div>
              ...
              <div className="notice mt">
                ...
                <Link href="/ru/metodologiya">формула целиком</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-tight paper-alt">
        <div className="wrap">
          <div className="notice">
            ...
            <Link href="/ru/metodologiya">Формула подбора открыта целиком</Link>
          </div>
        </div>
      </section>
    </>
