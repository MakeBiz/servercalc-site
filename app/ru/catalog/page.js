...
export const metadata = {
  ...
  alternates: { canonical: '/ru/catalog' },
};
  ...
  return (
    <>
          ...
          itemListElement: rows.slice(0, 40).map((r, i) => ({
            ...
            item: {
              ...
              offers: {
                ...
                url: absUrl(`/ru/provajdery/${r.providerSlug}`),
              },
            },
          })),
        }}
      ...
      <PageHead
        ...
        crumbs={[{ href: '/ru/catalog', label: 'Каталог тарифов' }]}
        badges={
          <>
        ...
        <div className="wrap">
          ...
          <div className="grid-3 mt-lg">
            <div className="notice">
              ...
              <Link href="/ru/novosti/pochemu-my-skryvaem-ustarevshie-tarify">
            ...
            <div className="notice">
              ...
              <Link href="/ru/novosti/skolko-na-samom-dele-stoit-server">
            ...
            <div className="notice">
              ...
              <Link href="/ru/metodologiya">методология</Link>
            </div>
          </div>
