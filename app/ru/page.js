        ...
        <div className="wrap">
          ...
          <div className="cards" style={{ marginTop: 8 }}>
            ...
            <div className="card">
              ...
              <div className="card-foot">
                <Link href="/ru/metodologiya" className="link-arrow">
                  Методология
                </Link>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="card-foot">
                <Link href="/ru/provajdery" className="link-arrow">
                  Обзоры провайдеров
                </Link>
              </div>
            </div>
      ...
      <section className="section paper-alt">
        <div className="wrap">
          ...
          <div className="cards cards-4">
            {TASKS.map((task) => (
              <Link key={task.slug} href={`/ru/vps-dlya/${task.slug}`} className="card">
                <div className="card-top">
      ...
      <section className="section paper">
        <div className="wrap">
          ...
          <div className="cards cards-4 mt">
            {GEO_PAGES.map((geo) => (
              <Link key={geo.slug} href={`/ru/vps/${geo.slug}`} className="card">
      ...
      <section className="section paper-alt">
        <div className="wrap">
          <div className="between mb">
            ...
            <Link href="/ru/provajdery" className="btn btn-ghost">
              Все провайдеры
            </Link>
          </div>
          ...
          <div className="grid-2">
            <div>
              ...
              <div className="row mt">
                <Link href="/ru/catalog" className="btn btn-brass">
                  Открыть каталог
                </Link>
                <Link href="/ru/metodologiya" className="btn btn-ghost">
                  Как считаем
                </Link>
              </div>
            </div>
      ...
      <section className="section paper">
        <div className="wrap">
          <div className="between mb">
            ...
            <Link href="/ru/novosti" className="btn btn-ghost">
              Все материалы
            </Link>
          </div>
          <div className="cards cards-2">
            {posts.map((post) => (
              <Link key={post.slug} href={`/ru/novosti/${post.slug}`} className="card">
                <div className="card-top">
