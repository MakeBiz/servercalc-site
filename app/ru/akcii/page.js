  ...
  return (
    <>
      ...
      <PageHead
        ...
        crumbs={[{ href: '/ru/akcii', label: 'Акции и промокоды' }]}
        badges={
          <>
        ...
        <div className="wrap">
          {!HAS_PROMOS ? (
            <div className="notice notice-warn" style={{ maxWidth: 720 }}>
              ...
              Пока загляните в <Link href="/ru/catalog">каталог тарифов</Link>: базовые цены там
              ...
              {PROMOS.map((p) => (
                <div className="card" key={p.id}>
                  ...
                  <div className="row mt">
                    ...
                    <Link href={`/ru/provajdery/${p.provider.slug}`} className="btn btn-ghost btn-sm">
                      Обзор провайдера
                    </Link>
                  </div>
          ...
          <div className="grid-2 mt-lg">
            ...
            <div className="notice">
              ...
              срок оплаты. Цену продления смотрите в <Link href="/ru/catalog">каталоге</Link>:
