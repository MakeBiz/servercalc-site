    ...
    <>
      <JsonLd
        data={{
          ...
          mainEntityOfPage: absUrl(`/news/${slug}`),
          inLanguage: 'en-US',
        }}
      />
      ...
      <PageHead
        ...
        crumbs={[
          ...
          { href: `/news/${slug}`, label: post.title },
        ]}
        badges={
          <>
          ...
          {provider ? (
            <div className="cta-provider ink">
              ...
              <div className="row">
                ...
                <Link href={`/providers/${provider.slug}`} className="btn btn-ghost">
                  Review and plans
                </Link>
        ...
        <section className="section-tight paper-alt">
          <div className="wrap">
            ...
            <div className="cards cards-2">
              {others.map((p) => (
                <Link key={p.slug} href={`/news/${p.slug}`} className="card">
